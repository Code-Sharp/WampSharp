    ...
    public class Messages
    {
        ...
        static Messages()
        {
            ...
            mCallMessageForRpcWith2ComplexArgumentsUsingCurie = new WampMessage<MockRaw>();
            {
                ...
                arguments[3] = new MockRaw(new Dictionary<string, object>()
                                               {
                                                   {"value1", "23"},
                                                   {"value2", "singsing"},
                                                   {"value3", true},
            ...
            mCallMessageForRpcWith1ComplexObjectArgument = new WampMessage<MockRaw>();
            {
                ...
                arguments[2] = new MockRaw(new Dictionary<string, object>()
                                               {
                                                   {"category", "dinner"},
                                                   {"calories", 2309},
                                               });
            ...
            mPublishMessageWithComplexObjectAsPayload = new WampMessage<MockRaw>();
            {
                ...
                arguments[1] = new MockRaw(new Dictionary<string, object>()
                                               {
