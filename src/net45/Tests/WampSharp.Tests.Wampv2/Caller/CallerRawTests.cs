...
namespace WampSharp.Tests.Wampv2.Caller
{
    ...
    public class CallerRawTests
    {
        ...
        public IEnumerable<CallerTest> CallerTests
        {
            get
            {
                CallerTest ping1 = new CallerTest();
                ping1.TestName = "com.arguments.ping_1";
                ping1.SetupCall(new { }, "com.arguments.ping");
                ping1.SetupResult(new { }, new object[] { null });
                yield return ping1;

                CallerTest add21 = new CallerTest();
                add21.TestName = "com.arguments.add2_1";
                add21.SetupCall(new { }, "com.arguments.add2", new object[] { 2, 3 });
                add21.SetupResult(new { }, new object[] { 5 });
                yield return add21;

                CallerTest stars1 = new CallerTest();
                stars1.TestName = "com.arguments.stars_1";
                stars1.SetupCall(new { }, "com.arguments.stars");
                stars1.SetupResult(new { }, new object[] { "somebody starred 0x" });
                yield return stars1;

                CallerTest stars2 = new CallerTest();
                stars2.TestName = "com.arguments.stars_2";
                stars2.SetupCall(new { }, "com.arguments.stars", new object[] { }, new { nick = "Homer" });
                stars2.SetupResult(new { }, new object[] { "Homer starred 0x" });
                yield return stars2;

                CallerTest stars3 = new CallerTest();
                stars3.TestName = "com.arguments.stars_3";
                stars3.SetupCall(new { }, "com.arguments.stars", new object[] { }, new { stars = 5 });
                ...
                stars4.SetupCall(new { }, "com.arguments.stars", new object[] { }, new { nick = "Homer", stars = 5 });
                ...
                orders1.SetupCall(new { }, "com.arguments.orders", new object[] { "coffee" });
                orders1.SetupResult(new { }, new object[] { new object[] { 0, 1, 2, 3, 4 } });
                yield return orders1;

                CallerTest orders2 = new CallerTest();
                orders2.TestName = "com.arguments.orders_2";
                orders2.SetupCall(new { }, "com.arguments.orders", new object[] { "coffee" }, new { limit = 10 });
                ...
                arglen1.SetupCall(new { }, "com.arguments.arglen");
                arglen1.SetupResult(new { }, new object[] { new object[] { 0, 0 } });
                yield return arglen1;

                CallerTest arglen2 = new CallerTest();
                arglen2.TestName = "com.arguments.arglen_2";
                arglen2.SetupCall(new { }, "com.arguments.arglen", new object[] { 1, 2, 3 });
                arglen2.SetupResult(new { }, new object[] { new object[] { 3, 0 } });
                yield return arglen2;

                CallerTest arglen3 = new CallerTest();
                arglen3.TestName = "com.arguments.arglen_3";
                arglen3.SetupCall(new { }, "com.arguments.arglen", new object[] { }, new { a = 1, b = 2, c = 3 });
                ...
                arglen4.SetupCall(new { }, "com.arguments.arglen", new object[] { 1, 2, 3 }, new { a = 1, b = 2, c = 3 });
                ...
                add_complex1.SetupCall(new { }, "com.myapp.add_complex", new object[] { 2, 3, 4, 5 });
                add_complex1.SetupResult(new { }, new object[] { }, new { c = 6, ci = 8 });
                yield return add_complex1;

                CallerTest split_name1 = new CallerTest();
                split_name1.TestName = "com.myapp.split_name_1";
                split_name1.SetupCall(new { }, "com.myapp.split_name", new object[] { "Homer Simpson" });
                split_name1.SetupResult(new { }, new object[] { "Homer", "Simpson" });
                yield return split_name1;

                CallerTest sqrt1 = new CallerTest();
                sqrt1.TestName = "com.myapp.sqrt_1";
                sqrt1.SetupCall(new { }, "com.myapp.sqrt", new object[] { 2 });
                sqrt1.SetupResult(new { }, new object[] { 1.4142135623731 });
                yield return sqrt1;

                CallerTest sqrt2 = new CallerTest();
                sqrt2.TestName = "com.myapp.sqrt_2";
                sqrt2.SetupCall(new { }, "com.myapp.sqrt", new object[] { 0 });
                ...
                sqrt3.SetupCall(new { }, "com.myapp.sqrt", new object[] { -2 });
                ...
                slowsquare1.SetupCall(new { }, "com.math.slowsquare", new object[] { 3 });
                slowsquare1.SetupResult(new { }, new object[] { 9 });
                yield return slowsquare1;

                CallerTest square1 = new CallerTest();
                square1.TestName = "com.math.square_1";
                square1.SetupCall(new { }, "com.math.square", new object[] { 3 });
                square1.SetupResult(new { }, new object[] { 9 });
                yield return square1;

                CallerTest now1 = new CallerTest();
                now1.TestName = "com.timeservice.now_1";
                now1.SetupCall(new { }, "com.timeservice.now");
                now1.SetupResult(new { }, new object[] { new DateTime(2014, 4, 8, 19, 48, 36, 956) });
                yield return now1;
            }
        }
    }
