...
namespace WampSharp.V2.Rpc
{
    ...
    public interface IWampRpcOperationInvoker
    {
        ...
        /// <param name="procedure">The procedure to invoke.</param>
        /// <typeparam name="TMessage"></typeparam>
        void Invoke<TMessage>(IWampRawRpcOperationClientCallback caller, IWampFormatter<TMessage> formatter, InvocationDetails details, string procedure);
        ...
        /// <param name="arguments">The arguments associated with this call.</param>
        /// <typeparam name="TMessage"></typeparam>
        void Invoke<TMessage>(IWampRawRpcOperationClientCallback caller, IWampFormatter<TMessage> formatter, InvocationDetails details, string procedure, TMessage[] arguments);
        ...
        /// <param name="argumentsKeywords">The arguments keywords associated with this call.</param>
        /// <typeparam name="TMessage"></typeparam>
        void Invoke<TMessage>(IWampRawRpcOperationClientCallback caller, IWampFormatter<TMessage> formatter, InvocationDetails details, string procedure, TMessage[] arguments, IDictionary<string, TMessage> argumentsKeywords);    
    }
}